    ...
    class List extends Component {  
          constructor(){   
              ...
              this.state = {  
                   siswa : [  
                       {nis: "100", nama: "Dazai", alamat: "Yokohama"},  
                        {nis: "101", nama: "Chuuya", alamat: "Shinjuku"},  
                         {nis: "102", nama: "Akutagawa", alamat: "Tokyo"},  
                        ],  
                         nis: "",  
                         nama: "",  
                          alamat: "",
                    ...
                    <div className="modal-dialog">  
                     <div className="modal-content">  
                      ...
                      <form onSubmit={this.SaveSiswa}>  
                       <div className="modal-body">  NIS  
                       <input type="text" name="nis" className="form-control" onChange={this.bind}  
                        value={this.state.nis} />  Nama  
                        <input type="text" name="nama" className="form-control" onChange={this.bind}  
                            value={this.state.nama} />   Alamat  <input type="text" name="alamat" className="form-control" onChange={this.bind}  
